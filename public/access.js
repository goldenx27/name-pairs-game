(() => {
  ...
  async function loadChildren(){
    ...
    $('#activeChildBanner').innerHTML=active?`<span>🎮 ילד פעיל</span><b>${esc(active.display_name)}</b><small>${active.parent_name?`משויך ל: ${esc(active.parent_name)}`:'לא משויך להורה'}</small>`:`<span>🎮 ילד פעיל</span><b>לא נבחר ילד</b><small>בחר "שחק" ליד ילד כדי להפוך אותו לילד הפעיל במכשיר הזה.</small>`;
